              ...
              <tbody>
                <?php if ($result->num_rows > 0): ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="uploads/<?= $row['berkas'] ?>" download><?= $row['berkas'] ?></a> // Berkas: Menyediakan tautan unduh untuk berkas yang diunggah.
                    </td>
...
<div class="row justify-content-center mt-5">
  ...
  <script>
    ...
    const pieChart = new Chart(ctx, {
      type: 'pie',
      data: {
        labels: <?= json_encode($beasiswa_labels) ?>, // Label dari PHP
        datasets: [{
          data: <?= json_encode($beasiswa_counts) ?>, // Data jumlah dari PHP
