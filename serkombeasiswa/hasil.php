...
<html lang="id">
<head>
  <meta charset="UTF-8"> // Mengatur encoding dokumen agar mendukung karakter UTF-8, termasuk karakter bahasa Indonesia.
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Data Mahasiswa</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"> //Mengimpor pustaka CSS Bootstrap untuk styling yang modern dan responsif.
  <style>
    body {
